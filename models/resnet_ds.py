...
__all__ = ['ResNet', 'resnet18_ds', 'resnet34', 'resnet50', 'resnet101',
...
class ResNet(nn.Module):
    def __init__(self, block, layers, bn_names, num_classes=10, zero_init_residual=False,
...
def resnet18_ds(pretrained=False, progress=True, **kwargs):
